...
public interface ManageService {
	...
	public List<ManageGroupVO> selectMyManageGroupList(String ownerId, List<String> projectIdList, String groupName, String roleName);
	...
	// 그룹 구성원 추가
	public Map<String, Object> addGroupMember(String projectGroupId, String projectMemberId, String ownerId);

	// 그룹 구성원 제외
	public Map<String, Object> removeGroupMember(String projectGroupId, String projectMemberId, String ownerId);
	
	// 그룹 구성원 여러 명 추가
	public Map<String, Object> addGroupMemberList(String projectGroupId, List<String> projectMemberIds, String ownerId);
}